...
CREATE TABLE "new_UserCollection" (
    ...
    "name" TEXT NOT NULL,
    "description" TEXT,
    "collectionType" TEXT NOT NULL DEFAULT 'Set',
...
INSERT INTO "new_UserCollection" ("createdAt", "description", "id", "isPublic", "isSystem", "name", "systemType", "updatedAt", "userId") SELECT "createdAt", "description", "id", "isPublic", "isSystem", "name", "systemType", "updatedAt", "userId" FROM "UserCollection";
